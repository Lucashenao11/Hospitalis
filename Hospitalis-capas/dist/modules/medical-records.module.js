...
const medical_records_controller_1 = require("../presentation/controllers/medical-records.controller");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: medical_record_schema_1.MedicalRecordSchema.name, schema: medical_record_schema_1.MedicalRecordMongooseSchema },
            ]),
