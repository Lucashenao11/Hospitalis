...
const appointments_service_1 = require("../application/services/appointments.service");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: appointment_schema_1.AppointmentSchema.name, schema: appointment_schema_1.AppointmentMongooseSchema },
            ]),
        ],
