...
const patients_controller_1 = require("../presentation/controllers/patients.controller");
const patients_service_1 = require("../application/services/patients.service");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: patient_schema_1.PatientSchema.name, schema: patient_schema_1.PatientMongooseSchema },
            ]),
        ],
